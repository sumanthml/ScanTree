...
> **Execution Time:** 2026-06-23 04:43:41  
...
| Metric | Value |
| :--- | :---: |
| 🔁 Requests per Second (RPS) | **439.26 req/sec** |
| ⏱️ Average Response Time | **226.93 ms** |
| 🟢 Min Response Time | **93.0 ms** |
| 🔴 Max Response Time | **1640.37 ms** |
| 📦 Total Requests Sent | **26473** |
| ✅ Successful Requests | **26473** |
| ❌ Failed Requests | **0** |
...
| :---: | :--- | :---: | :---: | ---: |
| 1 | Test 1: Web App Title Verification | Web (Selenium) | ✅ Passed | 3464 ms |
| 2 | Test 2: Login Screen Inputs | Web (Selenium) | ✅ Passed | 22 ms |
| 3 | Test 3: Register Navigation | Web (Selenium) | ✅ Passed | 3285 ms |
| 4 | Test 4: Forgot Password Navigation | Web (Selenium) | ✅ Passed | 3141 ms |
| 5 | Test 5: Authenticated Session Initialization | Web (Selenium) | ✅ Passed | 5168 ms |
| 6 | Test 6: Dashboard View | Web (Selenium) | ✅ Passed | 13 ms |
| 7 | Test 7: Reports Screen | Web (Selenium) | ✅ Passed | 1095 ms |
| 8 | Test 8: Upload Screen | Web (Selenium) | ✅ Passed | 1113 ms |
| 9 | Test 9: Analytics Screen | Web (Selenium) | ✅ Passed | 1094 ms |
| 10 | Test 10: Notifications Screen | Web (Selenium) | ✅ Passed | 1091 ms |
| 11 | Test 11: Access Screen | Web (Selenium) | ✅ Passed | 1094 ms |
| 12 | Test 12: Profile Screen | Web (Selenium) | ✅ Passed | 1107 ms |
| 13 | Test 13: Settings Screen | Web (Selenium) | ✅ Passed | 1093 ms |
| 14 | Test 14: Logout Flow | Web (Selenium) | ✅ Passed | 3147 ms |
...
| 23 | Test 15: Baseline/Load Testing | Load (httpx) | ✅ Passed | 60268 ms |
...
*Report auto-generated by ScanTrace CI/CD — 2026-06-23 04:43:41*
